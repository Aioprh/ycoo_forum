  ...
  Widget build(BuildContext context) => ListView(
    ...
    children: [
      Card(child: Padding(padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('星币余额', style: Theme.of(context).textTheme.titleMedium), const SizedBox(height: 8),
        Text(summary.balance, style: Theme.of(context).textTheme.displaySmall),
      ]))),
      const SizedBox(height: 12), Text('积分 / 交易信息', style: Theme.of(context).textTheme.titleMedium), const SizedBox(height: 8),
      if (summary.records.isEmpty) const Card(child: Padding(padding: EdgeInsets.all(16), child: Text('暂无交易记录'))) else ...summary.records.map((e) => Card(child: ListTile(title: Text(e)))),
    ],
  );
}
...
class _ErrorView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(child: Padding(
    ...
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      const Icon(Icons.cloud_off, size: 48), const SizedBox(height: 12), Text(message, textAlign: TextAlign.center), const SizedBox(height: 12),
