      ...
      child: Column(children: [
        InkWell(
          ...
          child: Padding(
            ...
            child: Row(children: [
              Container(width: 4, height: 23, decoration: BoxDecoration(color: s.secondary, borderRadius: BorderRadius.circular(4))),
              const SizedBox(width: 10),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                const Text('评论 / 回复', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
                const SizedBox(height: 2),
                Text('下面是其他用户的回复内容', style: TextStyle(fontSize: 11.5, color: s.onSurfaceVariant)),
              ])),
        ...
        if (_commentsExpanded) ...[
          ...
          Padding(padding: const EdgeInsets.fromLTRB(10, 10, 10, 8), child: SizedBox(height: _commentsHeight > 0 ? _commentsHeight : 180, child: WebViewWidget(controller: _commentsController!))),
        ],
      ]),
    );
  }
