        ...
        child: Column(
          ...
          children: [
            Row(children: [
              ...
              TextButton.icon(
                onPressed: _uploading || _submitting ? null : _pickAttachments,
                icon: const Icon(Icons.add_rounded, size: 18),
                label: const Text('添加'),
              ),
            ]),
            const SizedBox(height: 3),
            Text('单个附件最大 10 MB，使用论坛原生上传接口。', style: TextStyle(fontSize: 12, color: scheme.onSurfaceVariant)),
            if (_uploading) ...[
            ...
            if (_attachments.isNotEmpty) ...[
              ...
              ..._attachments.map((attachment) => ListTile(
                ...
                trailing: IconButton(
                  tooltip: '移除',
                  onPressed: _uploading || _submitting ? null : () => _removeAttachment(attachment.aid),
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: FilledButton(
              onPressed: _submitting || _uploading || _loadingBoards ? null : _submit,
              child: _submitting
            ...
            children: [
              ...
              if (_boards.isNotEmpty) ...[
                DropdownButtonFormField<int>(
                  ...
                  onChanged: _submitting || _uploading ? null : (v) {
                    setState(() => _fid = v);
              ...
              if (_loadingTypes) const Padding(padding: EdgeInsets.symmetric(vertical: 4), child: LinearProgressIndicator(minHeight: 2)),
              TextFormField(
                controller: _title,
              ...
              const SizedBox(height: 10),
              Text('附件直接上传到源论坛，不经过第三方服务。上传成功后会在最终发帖请求中绑定到主题。', textAlign: TextAlign.center, style: TextStyle(fontSize: 12, color: Colors.grey.shade600)),
            ],
          ),
        ),
      ),
