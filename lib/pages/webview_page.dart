  ...
  Future<void> _runNativePurchase() async {
    ...
    if (widget.url.startsWith('ycoo-native-purchase://')) {
      final raw = widget.url
          .substring('ycoo-native-purchase://'.length)
          .split('?')
          .first;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Icon(
                  _error ? Icons.error_outline : Icons.shopping_cart_outlined,
                  size: 48,
                ),
