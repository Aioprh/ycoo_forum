...
class _NativeProfilePageState extends State<NativeProfilePage> with SingleTickerProviderStateMixin {
  ...
  static bool _isUsableName(String value) {
    ...
    return !RegExp(r'^(?:资料|个人资料|用户资料|用户|用户名|昵称|关注|已关注|聊天|私信|回复|主题|回帖|帖子|帖子数|粉丝|积分|星币|登录|注册|退出|刷新)$', caseSensitive: false).hasMatch(compact);
  }
}
...
class _NameParts {
  ...
  static bool _isUiLabel(String value) => RegExp(r'^(?:资料|个人资料|用户资料|用户|用户名|昵称|关注|已关注|聊天|私信|回复|主题|回帖|帖子|帖子数|粉丝|积分|星币|登录|注册|退出|刷新)$', caseSensitive: false).hasMatch(value.trim());
}
