  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(children: [
        _item(context: context, icon: Icons.chat_bubble_rounded, color: Colors.lightBlue, title: '我的消息', subtitle: '站内私信', onTap: () => _open(context, const NativeMessageListPage())),
        ...
        const Divider(height: 1),
        _item(context: context, icon: Icons.smart_toy_rounded, color: Colors.redAccent, title: '系统提醒', subtitle: '系统消息和账号提醒', onTap: () => _open(context, const NativeNoticeListPage(title: '系统提醒', view: 'system'))),
        const Divider(height: 1),
        _item(context: context, icon: Icons.notifications_active_rounded, color: Colors.blueAccent, title: '应用提醒', subtitle: '应用和社区服务提醒', onTap: () => _open(context, const NativeNoticeListPage(title: '应用提醒', view: 'app'))),
        const Divider(height: 1),
      ]),
    );
  }
