...
> **本项目、本软件完全开源、完全免费。**
>
> 本项目不会以任何形式向用户收取软件购买费用，也不存在所谓的「正版激活码」「付费版」「会员版」「解锁版」或「授权码」。
>
> **任何人以本项目、本软件的名义向你收费售卖软件、安装包、激活码、授权码、会员资格或所谓的内部版本，均不是本项目官方提供的服务。**
>
> 如果有人声称「花钱购买本软件」「付费才能使用」「购买后才能获得完整功能」，请务必提高警惕。**本项目免费开源，花钱购买本软件本身并没有必要，请谨防被骗。**
>
> 获取本项目请优先通过本仓库及作者公开发布渠道，不要从不明来源购买所谓的「破解版」「付费版」或「官方授权版」。
...
本项目不会出售软件本体、付费激活码、授权码、会员资格或所谓「官方付费版」。

**任何人以本项目、本软件名义进行收费售卖，均非本项目官方提供的服务。**如果有人要求你花钱购买本软件、购买激活码或付费解锁功能，请不要付款，并谨防被骗。

本项目源码及公开版本以本 GitHub 仓库为准：

<https://github.com/Aioprh/ycoo_forum>
